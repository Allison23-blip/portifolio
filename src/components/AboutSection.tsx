...
export const AboutSection: React.FC<AboutSectionProps> = ({ onContactClick }) => {
  const aboutBio =
    "Com mais de cinco anos de experiência em design, foco em branding, web design e experiência do usuário. Gosto genuinamente de trabalhar com marcas que buscam se destacar e apresentar sua melhor imagem. Vamos criar algo incrível juntos!";
